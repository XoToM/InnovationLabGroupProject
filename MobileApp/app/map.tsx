...
export default function ScreenMap() {
  ...
  const locations = [
    {
      name: "Park",
      pos: [51.37692748456796, -2.436908958136046],
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/50/Halleyparknovember_b.jpg/800px-Halleyparknovember_b.jpg",
    },
    {
      name: "Castle1",
      pos: [51.379306590874634, -2.354695695635474],
      img: "https://nt.global.ssl.fastly.net/binaries/content/gallery/website/national/regions/sussex/places/bodiam-castle/library/winter/bodiam-castle-and-moat-in-winter-1456846.jpg",
    },
    {
      name: "Castle2",
      pos: [52.956237708377174, 4.760612002768222],
      img: "https://nt.global.ssl.fastly.net/binaries/content/gallery/website/national/regions/sussex/places/bodiam-castle/library/winter/bodiam-castle-and-moat-in-winter-1456846.jpg",
    },
    {
      name: "Castle3",
      pos: [35.68616796711613, 139.75224497059952],
      img: "https://nt.global.ssl.fastly.net/binaries/content/gallery/website/national/regions/sussex/places/bodiam-castle/library/winter/bodiam-castle-and-moat-in-winter-1456846.jpg",
    },
  ];
  return (
    <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
      {Constants.expoConfig?.extra?.MAPBOX_ACCESS_TOKEN ? (
        <MapView style={StyleSheet.absoluteFillObject} compassEnabled={true}>
          <Camera
            defaultSettings={{ centerCoordinate: [0, 0], zoomLevel: 9 }}
          />
          ...
          {locations.map((loc, i) => {
            return (
              <PointAnnotation
                key={i + ">" + loc.name}
                id={"" + i}
                coordinate={[loc.pos[1], loc.pos[0]]}
                anchor={{ x: 0.5, y: 1 }}
                onSelected={() =>
                  router.push({
                    pathname: "./place",
        ...
        <Text style={StyleSheet.absoluteFillObject}>No tokens provided</Text>
      )}
      {/*
